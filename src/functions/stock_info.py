...
# constants
from functions.constants import VALID_PERIODS, PRICE_PLOT_PATH, GROWTH_PLOT_PATH, INCLUDE_FIELDS
...
def get_info(ticker: str) -> dict:
    ...
    try:
        ...
        return {x: y for x, y in ticker.info.items() if x in INCLUDE_FIELDS}
